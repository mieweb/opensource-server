...
install-create-container:
	...
	echo 'DATABASE_DIALECT=sqlite' >> create-a-container/.env
	echo 'SQLITE_STORAGE=/opt/opensource-server/create-a-container/database.sqlite' >> create-a-container/.env
