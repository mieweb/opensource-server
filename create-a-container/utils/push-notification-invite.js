 ...
 * @returns {Promise<{success: boolean, inviteUrl?: string, expiresAt?: string, error?: string}>}
 */
async function sendPushNotificationInvite(user) {
  ...
  if (!url || !apiKey) {
    return { success: false, error: 'Push notification URL or API key not configured' };
  }
