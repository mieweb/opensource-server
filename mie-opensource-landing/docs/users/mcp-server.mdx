...
- An API key from <ContainerCreationUrl path="/apikeys">your server</ContainerCreationUrl> (see [API Keys](./creating-containers/api-keys.mdx))
...
| `AUTH_TOKEN` | Your API key (see [API Keys](./creating-containers/api-keys.mdx)) |
