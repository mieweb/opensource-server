...
**Next Steps**: Learn about [Path 2: Automatic Runner Provisioning](/docs/users/proxmox-launchpad/automatic-runner-provisioning) for automatically provisioning your runners.
